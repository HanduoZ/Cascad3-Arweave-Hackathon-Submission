...
/** 启发 */
export function inspiredVOListReq(keyword: string, cascadeId: string) {
...
/** 点赞 */
export function clickLikeReq(id: number, cascadeId: string) {
  return fetch.post<ApiResData<boolean>>(
    '/client/cascade/user/piece/clickLike',
    {
      id,
    },
    {
...
/** 修改用户权限 */
export function changeUserRoleReq(id: number, cascadeId: string) {
  return fetch.post<ApiResData<boolean>>(
    '/client/cascade/su/user/changeUserRole',
    { id },
    {
      headers: {
        cascadeInfo: JSON.stringify({ cascadeId: cascadeId }),
...
/** 移除用户权限 */
export function banUserReq(id: number, cascadeId: string) {
  return fetch.post<ApiResData<boolean>>(
    '/client/cascade/su/user/banUser',
    { id },
    {
      headers: {
        cascadeInfo: JSON.stringify({ cascadeId: cascadeId }),
